...
<body>
    ...
    <section class="section1">
        ...
        <div class="text">
            <h2>Vehicle Law</h2>
            <hr>
            <p>Vehicle Purchase and Sale: This includes reviewing and advising on contracts for vehicle purchase, sale, or lease agreements,
                 assisting with the transfer of vehicle titles and registration documents. 
                <br>
                Vehicle Ownership and Operation: This includes advising on traffic violations and legal consequences, assisting clients in filing and defending
                 accident claims, and resolving disputes with insurance companies regarding coverage, claims, or premiums.
    ...
    <section class="home">
        ...
        <div class="home-content">
            ...
            <p>10 years in vehicle law and consulting Skills: Vehicle law, regulatory compliance, and policy analysis.</p>
    ...
    <section class="home">
        ...
        <div class="home-content">
            <h1>Hi, It's <span>Michael</span></h1>
            <h3 class="typing-text">I'm a <span></span></h3>
            <p>12 years in automotive law and litigation Skills: Automotive law, product liability, and class action lawsuits.
                </p>
            <div class="social-icons">
                <a href="#"><i class="fa-brands fa-linkedin"></i></a>
                <a href="#"><i class="fa-brands fa-github"></i></a>
    ...
    <section class="home">
        ...
        <div class="home-content">
            ...
            <h3 class="typing-text">I'm a <span></span></h3>
            <p>15 years in transportation law and consulting Skills: Transportation law, regulatory compliance, and logistics management.</p>
            <div class="social-icons">
                <a href="#"><i class="fa-brands fa-linkedin"></i></a>
                <a href="#"><i class="fa-brands fa-github"></i></a>
                <a href="#"><i class="fa-brands fa-x-twitter"></i></a>
