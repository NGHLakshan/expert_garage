...
<body>
    ...
    <section class="section1">
        ...
        <div class="text">
            <h2>Vehicle Valuation and Appraisal</h2>
            <hr>
            <p>Market Value Assessment: Determining the fair market value of a vehicle based on its condition, mileage, and other factors.
                <br>

                Damage Assessment: Evaluating the extent of damage to a vehicle after an accident or incident.
                <br>
                Insurance Claims Support: Assisting clients in filing insurance claims and negotiating settlements.
    ...
    <section class="home">
        ...
        <div class="home-content">
            ...
            <p> Vehicle valuation and appraisal, Oregon total loss vehicle appraisal, licensed vehicle appraiser, 
                vehicle inspection, vehicle damage assessment.</p>
    ...
    <section class="home">
        ...
        <div class="home-content">
            ...
            <h3 class="typing-text">I'm a <span></span></h3>
            <p>Vehicle valuation and appraisal, vehicle inspection, vehicle damage assessment, 
                total loss vehicle appraisal, Diminished Value Appraisal.</p>
            <div class="social-icons">
                <a href="#"><i class="fa-brands fa-linkedin"></i></a>
                <a href="#"><i class="fa-brands fa-github"></i></a>
                <a href="#"><i class="fa-brands fa-x-twitter"></i></a>
