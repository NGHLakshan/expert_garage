...
<body>
    ...
    <section class="section1">
        ...
        <div class="text">
            <h2>Vehicle Maintenance and Repairl</h2>
            <hr>
            <p>Preventive Maintenance: Recommending regular maintenance schedules to keep vehicles in optimal condition.
                <br>
            Repair Recommendations: Advising on necessary repairs and providing quotes from trusted mechanics.
            <br>
            Warranty Claims Assistance: Helping clients navigate warranty claims processes.
    ...
    <section class="home">
        ...
        <div class="home-content">
            ...
            <p> 12 years in fleet maintenance and repair management Skills: Fleet optimization, maintenance scheduling, and repair cost.</p>
    ...
    <section class="home">
        ...
        <div class="home-content">
            <h1>Hi, It's <span>James</span></h1>
            <h3 class="typing-text">I'm a <span></span></h3>
            <p>8 years in vehicle inspection and maintenance consulting Skills: Vehicle inspection, maintenance scheduling, and repair prioritization</p>
            <div class="social-icons">
                <a href="#"><i class="fa-brands fa-linkedin"></i></a>
                <a href="#"><i class="fa-brands fa-github"></i></a>
                <a href="#"><i class="fa-brands fa-x-twitter"></i></a>
    ...
    <section class="home">
        ...
        <div class="home-content">
            ...
            <h3 class="typing-text">I'm a <span></span></h3>
            <p>Vehicle valuation and appraisal, vehicle inspection, vehicle damage assessment, total loss vehicle appraisal, Diminished Value Appraisal.</p>
            <div class="social-icons">
                <a href="#"><i class="fa-brands fa-linkedin"></i></a>
                <a href="#"><i class="fa-brands fa-github"></i></a>
                <a href="#"><i class="fa-brands fa-x-twitter"></i></a>
